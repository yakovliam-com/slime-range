package com.yakovliam.slimerange.api.config.generic;

import com.yakovliam.slimerange.api.config.generic.adapter.ConfigurationAdapter;
import com.yakovliam.slimerange.api.config.generic.key.ConfigKey;
import com.yakovliam.slimerange.api.config.generic.key.SimpleConfigKey;
import com.yakovliam.slimerange.api.config.util.ImmutableCollectors;
